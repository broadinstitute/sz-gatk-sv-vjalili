...
EXPECTED_COLUMNS = ["name", "chrom", "start", "end", "svtype", "svsize", "vf", "rmsk", "poor_region_cov", "SR1Q",
                    ...
                    "BAFDEL", "BAFDUP", "is_outlier_specific", "RD_Median_Power", "RD_P", "RD_2ndMaxP", "RD_Model",
                    "RD_Median_Rank", "RD_Median_Separation", "RD_log_pval", "RD_log_2ndMaxP"]
...
def main(argv):
    ...
    feature_cols = ["poor_region_cov", "is_outlier_specific",
                    "SRQ", "SRCS", "PEQ", "PECS", "PESRQ", "PESRCS", "BAFDEL", "BAFDUP",
